...
export const teacherSchema = z.object({
  ...
  classIds: z.array(z.coerce.number()).min(1, { message: "At least one class must be selected." }),
...
export const lessonSchema = z.object({
  ...
  day: z.enum(["MONDAY", "TUESDAY", "WEDNESDAY", "THURSDAY", "FRIDAY"], { message: "Invalid day!" }),
  startTime: z.coerce.date({ message: "Start time is required!" }),
  endTime: z.coerce.date({ message: "End time is required!" }),
...
export const messageSchema = z.object({
  ...
  createdAt: z.coerce.date().optional(), // Typically set automatically on creation
});
